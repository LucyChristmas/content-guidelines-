...
These guidelines help you create **consistent, accessible, high-quality content** across all University of Otago communications—whether you're writing for web, digital platforms, or working with AI writing tools.

**Key benefits:**
- ✅ Maintain brand consistency across all content
- ✅ Improve content quality and readability
- ✅ Streamline content review processes
- ✅ Get better results from AI writing tools
...
**For writers:**
1. Start with the [quick reference guide](quick-reference.md) for essential rules
2. Refer to specific guides as needed for detailed guidance

**For web content:**
1. Use the [web writing quick reference](web-quick-reference.md)
2. Check the full [web best practice guide](web-best-practice.md) for detailed rules

**For AI tool users:**
1. Attach relevant guides to your AI conversations
2. Use the prompt templates in [using with AI tools](#using-with-ai-tools) section below
...
│
├── quick-reference.md
│   └── One-page essentials for digital content
│
├── web-quick-reference.md
│   └── One-page essentials specifically for web content
│
├── part-1-universal-style-rules.md
│   └── Comprehensive guide: spelling, grammar, numbers, punctuation, 
│       formatting
│
├── part-2-otago-specific-terminology.md
│   └── University-specific names, titles, programmes, buildings,
...
**Start with:**
- [Web writing quick reference](web-quick-reference.md)

**Then consult:**
- [Web best practice guide](web-best-practice.md) for comprehensive web rules
- [Part 2: Otago-specific terminology](part-2-otago-specific-terminology.md) for proper names
...
**Then consult:**
- [Part 1: Universal style rules](part-1-universal-style-rules.md) for detailed guidance
- [Part 2: Otago-specific terminology](part-2-otago-specific-terminology.md) for proper names
...
### Quick questions
Check the quick reference guides first—they cover the most common questions.
